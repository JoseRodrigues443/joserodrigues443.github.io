---
title: How to write technical documents in Hugo
subtitle: 'Understand how to implement technical documents in Hugo :construction_worker:'
summary: Understand how to implement technical documents in Hugo :construction_worker:.
date: 2022-01-12
tags:
- mermaid.js
- diagrams
...
By doing `{{\< gist USER GIST_ID  \>}}`we can show a given gist.

It would render like:

{{< gist JoseRodrigues443 de8de668ede0f887bf8bd88419943a42  >}}
